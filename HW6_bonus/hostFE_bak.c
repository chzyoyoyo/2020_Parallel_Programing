            ...
            cl_context *context, cl_program *program)
{
    ...
    // cl_mem filwid_mem_obj = clCreateBuffer(context, CL_MEM_READ_ONLY,
    //         sizeof(int), NULL, &ret);
    cl_mem fil_mem_obj = clCreateBuffer(*context, CL_MEM_READ_ONLY, 
            filterSize * sizeof(cl_float), NULL, &ret);

    // cl_mem hei_mem_obj = clCreateBuffer(context, CL_MEM_READ_ONLY, 
    //         sizeof(int), NULL, &ret);
    // cl_mem wid_mem_obj = clCreateBuffer(context, CL_MEM_READ_ONLY,
    //         sizeof(int), NULL, &ret);
    ...
    // ret = clEnqueueWriteBuffer(command_queue, filwid_mem_obj, CL_TRUE, 0,
    ...
    ret = clEnqueueWriteBuffer(command_queue, in_mem_obj, CL_TRUE, 0, 
            imageWidth * imageHeight * sizeof(cl_float), inputImage, 0, NULL, NULL);
