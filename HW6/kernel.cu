...
__global__ void convolution2(int filterWidth, float *filter, int imageHeight, int imageWidth, float *inputImage, float *outputImage) 
{
...
void hostFE2(int filterWidth, float *filter, int imageHeight, int imageWidth,
            ...
            cl_context *context, cl_program *program)
{
	...
	int data_size = resX * resY * sizeof(float);
